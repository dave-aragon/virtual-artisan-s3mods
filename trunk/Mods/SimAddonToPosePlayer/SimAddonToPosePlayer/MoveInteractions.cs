...
namespace Misukisu.PosePlayerAddon
{
    ...
    class MoveRight : ImmediateInteraction<Sim, GameObject>
    {
        ...
        private sealed class Definition : InteractionDefinition<Sim, GameObject, MoveRight>
        {
    ...
    class MoveLeft : ImmediateInteraction<Sim, GameObject>
    {
        ...
        private sealed class Definition : InteractionDefinition<Sim, GameObject, MoveLeft>
        {
            public override bool Test(Sim actor, GameObject target, bool isAutonomous, ref Sims3.SimIFace.GreyedOutTooltipCallback greyedOutTooltipCallback)
            {
                return PoseManager.IsPosing(target) && !isAutonomous;
    ...
    class MoveForwardUserDefined : ImmediateInteraction<Sim, GameObject>
    {
        ...
        private sealed class Definition : InteractionDefinition<Sim, GameObject, MoveForwardUserDefined>
        {
            public override bool Test(Sim actor, GameObject target, bool isAutonomous, ref Sims3.SimIFace.GreyedOutTooltipCallback greyedOutTooltipCallback)
            {
                return PoseManager.IsPosing(target) && !isAutonomous;
    ...
    class MoveForward : ImmediateInteraction<Sim, GameObject>
    {
        ...
        private sealed class Definition : InteractionDefinition<Sim, GameObject, MoveForward>
        {
            public override bool Test(Sim actor, GameObject target, bool isAutonomous, ref Sims3.SimIFace.GreyedOutTooltipCallback greyedOutTooltipCallback)
            {
                return PoseManager.IsPosing(target) && !isAutonomous;
    ...
    class MoveBackUserDefined : ImmediateInteraction<Sim, GameObject>
    {
        ...
        private sealed class Definition : InteractionDefinition<Sim, GameObject, MoveBackUserDefined>
        {
            public override bool Test(Sim actor, GameObject target, bool isAutonomous, ref Sims3.SimIFace.GreyedOutTooltipCallback greyedOutTooltipCallback)
            {
                return PoseManager.IsPosing(target) && !isAutonomous;
    ...
    class MoveBack : ImmediateInteraction<Sim, GameObject>
    {
        ...
        private sealed class Definition : InteractionDefinition<Sim, GameObject, MoveBack>
        {
            public override bool Test(Sim actor, GameObject target, bool isAutonomous, ref Sims3.SimIFace.GreyedOutTooltipCallback greyedOutTooltipCallback)
            {
                return PoseManager.IsPosing(target) && !isAutonomous;
    ...
    class MoveUpUserDefined : ImmediateInteraction<Sim, GameObject>
    {
        ...
        private sealed class Definition : InteractionDefinition<Sim, GameObject, MoveUpUserDefined>
        {
            public override bool Test(Sim actor, GameObject target, bool isAutonomous, ref Sims3.SimIFace.GreyedOutTooltipCallback greyedOutTooltipCallback)
            {
                return PoseManager.IsPosing(target) && !isAutonomous;
    ...
    class MoveUp : ImmediateInteraction<Sim, GameObject>
    {
        ...
        private sealed class Definition : InteractionDefinition<Sim, GameObject, MoveUp>
        {
            public override bool Test(Sim actor, GameObject target, bool isAutonomous, ref Sims3.SimIFace.GreyedOutTooltipCallback greyedOutTooltipCallback)
            {
                return PoseManager.IsPosing(target) && !isAutonomous;
    ...
    class MoveDownUserDefined : ImmediateInteraction<Sim, GameObject>
    {
        ...
        private sealed class Definition : InteractionDefinition<Sim, GameObject, MoveDownUserDefined>
        {
            public override bool Test(Sim actor, GameObject target, bool isAutonomous, ref Sims3.SimIFace.GreyedOutTooltipCallback greyedOutTooltipCallback)
            {
                return PoseManager.IsPosing(target) && !isAutonomous;
    ...
    class MoveDown : ImmediateInteraction<Sim, GameObject>
    {
        ...
        private sealed class Definition : InteractionDefinition<Sim, GameObject, MoveDown>
        {
            public override bool Test(Sim actor, GameObject target, bool isAutonomous, ref Sims3.SimIFace.GreyedOutTooltipCallback greyedOutTooltipCallback)
            {
                return PoseManager.IsPosing(target) && !isAutonomous;
    ...
    class TurnLeft : ImmediateInteraction<Sim, GameObject>
    {
        ...
        private sealed class Definition : InteractionDefinition<Sim, GameObject, TurnLeft>
        {
            public override bool Test(Sim actor, GameObject target, bool isAutonomous, ref Sims3.SimIFace.GreyedOutTooltipCallback greyedOutTooltipCallback)
            {
                return PoseManager.IsPosing(target) && !isAutonomous;
    ...
    class TiltFaceUp : ImmediateInteraction<Sim, GameObject>
    {
        ...
        private sealed class Definition : InteractionDefinition<Sim, GameObject, TiltFaceUp>
        {
            public override bool Test(Sim actor, GameObject target, bool isAutonomous, ref Sims3.SimIFace.GreyedOutTooltipCallback greyedOutTooltipCallback)
            {
                return PoseManager.IsPosing(target) && !isAutonomous;
    ...
    class TiltBack : ImmediateInteraction<Sim, GameObject>
    {
        ...
        private sealed class Definition : InteractionDefinition<Sim, GameObject, TiltBack>
        {
            public override bool Test(Sim actor, GameObject target, bool isAutonomous, ref Sims3.SimIFace.GreyedOutTooltipCallback greyedOutTooltipCallback)
            {
                return PoseManager.IsPosing(target) && !isAutonomous;
    ...
    class TiltUserDefined : ImmediateInteraction<Sim, GameObject>
    {
        ...
        private sealed class Definition : InteractionDefinition<Sim, GameObject, TiltUserDefined>
        {
            public override bool Test(Sim actor, GameObject target, bool isAutonomous, ref Sims3.SimIFace.GreyedOutTooltipCallback greyedOutTooltipCallback)
            {
                return PoseManager.IsPosing(target) && !isAutonomous;
    ...
    class TiltForward : ImmediateInteraction<Sim, GameObject>
    {
        ...
        private sealed class Definition : InteractionDefinition<Sim, GameObject, TiltForward>
        {
            public override bool Test(Sim actor, GameObject target, bool isAutonomous, ref Sims3.SimIFace.GreyedOutTooltipCallback greyedOutTooltipCallback)
            {
                return PoseManager.IsPosing(target) && !isAutonomous;
    ...
    class TiltFaceDown : ImmediateInteraction<Sim, GameObject>
    {
        ...
        private sealed class Definition : InteractionDefinition<Sim, GameObject, TiltFaceDown>
        {
            public override bool Test(Sim actor, GameObject target, bool isAutonomous, ref Sims3.SimIFace.GreyedOutTooltipCallback greyedOutTooltipCallback)
            {
                return PoseManager.IsPosing(target) && !isAutonomous;
    ...
    class TurnRight : ImmediateInteraction<Sim, GameObject>
    {
        ...
        private sealed class Definition : InteractionDefinition<Sim, GameObject, TurnRight>
        {
            public override bool Test(Sim actor, GameObject target, bool isAutonomous, ref Sims3.SimIFace.GreyedOutTooltipCallback greyedOutTooltipCallback)
            {
                return PoseManager.IsPosing(target) && !isAutonomous;
    ...
    class TurnAround : ImmediateInteraction<Sim, GameObject>
    {
        ...
        private sealed class Definition : InteractionDefinition<Sim, GameObject, TurnAround>
        {
            public override bool Test(Sim actor, GameObject target, bool isAutonomous, ref Sims3.SimIFace.GreyedOutTooltipCallback greyedOutTooltipCallback)
            {
                return PoseManager.IsPosing(target) && !isAutonomous;
